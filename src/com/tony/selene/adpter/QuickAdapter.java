...
import static com.tony.selene.adpter.BaseAdapterHelper.get;
...
public abstract class QuickAdapter<T> extends BaseQuickAdapter<T, BaseAdapterHelper> {
	...
	public QuickAdapter(Context context, MultiItemTypeSupport<T> multiItemSupport, ArrayList<T> data) {
