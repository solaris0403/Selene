package com.tony.selene.view;

import com.tony.selene.R;
...
/**
 * <strong> Listview which can do something when drop down or scroll to bottom.
 * for example, drop down to refresh and load more when scroll to
 * bottom</strong>
 * <ul>
 * <strong>DropDown Listener</strong>
 * <li>define isDropDownStyle="true" at layout xml or call
 * {@link #setDropDownStyle(boolean)} to enable drop down style before</li>
 * <li>{@link #setOnDropDownListener(OnDropDownListener)} set listener which
 * will be excuted when drop down, but you should call
 * {@link #onDropDownComplete()} manual at the end of listener to reinstate
 * status.</li>
 * <li>{@link #setHeaderDefaultText(String)},
 * {@link #setHeaderLoadingText(String)}, {@link #setHeaderPullText(String)},
 * {@link #setHeaderReleaseText(String)},
 * {@link #setHeaderSecondText(CharSequence)} to set text</li>
 * </ul>
 * <ul>
 * <strong>OnBottom Listener</strong>
 * <li>define isOnBottomStyle="true" at layout xml or call
 * {@link #setOnBottomStyle(boolean)} to enable on bottom style before</li>
 * <li>{@link #setOnBottomListener(OnClickListener)} set listener which will be
 * excuted when scroll to bottom, but you should call
 * {@link #onBottomComplete()} manual at the end of listener to reinstate
 * status.</li>
 * <li>you can define isAutoLoadOnBottom="true" at layout xml or call
 * {@link #setAutoLoadOnBottom(boolean)} to enable auto call OnBottomListener
 * when scroll to bottom</li>
 * <li>{@link #setFooterDefaultText(String)},
 * {@link #setFooterLoadingText(String)}, {@link #setFooterNoMoreText(String)}
 * to set text</li>
 * </ul>
 * <ul>
 * other setting see <a
 * href="http://www.trinea.cn/?p=523">http://www.trinea.cn/?p=523</a>
 * </ul>
 * <ul>
 * principle see <a
 * href="http://trinea.iteye.com/blog/1562281">http://trinea.iteye
 * .com/blog/1562281</a>
 * </ul>
 * 
...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			 ...
			 * <ul>
			 * <li>if current header status is HEADER_STATUS_RELEASE_TO_LOAD,
			 * call onDropDown.</li>
			 * <li>if current header status is HEADER_STATUS_DROP_DOWN_TO_LOAD,
			 * then set header status to HEADER_STATUS_CLICK_TO_LOAD and hide
			 * header layout.</li>
			 * </ul>
			 */
	...
	private void resetHeaderPadding() {
		headerLayout.setPadding(headerLayout.getPaddingLeft(), headerOriginalTopPadding, headerLayout.getPaddingRight(), headerLayout.getPaddingBottom());
	}
