...
import com.tony.selene.util.AbAnimationUtil;

/**
 * © 2012 amsoft.cn 名称：AbDialogFragment.java 描述：弹出框的父类
 *
 * @author 还如一梦中
 * @version v1.0
 * @date：2014-07-30 下午16:00:52
 */
@SuppressLint("NewApi") public class TCDialogFragment extends DialogFragment {
	...
	public void load(View v) {
		...
		AbAnimationUtil.playRotateAnimation(mIndeterminateView, 300, Animation.INFINITE, Animation.RESTART);
	}
