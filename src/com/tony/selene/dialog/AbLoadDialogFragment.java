 ...
 */
public class AbLoadDialogFragment extends TCDialogFragment {
	private int mTheme;
	private int mStyle;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		parent.addView(mImageView, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
